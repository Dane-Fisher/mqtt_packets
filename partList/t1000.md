...
###			Command Info : 
                    ...
                    The set mode command will set the mode of the thermostat. it will result in the hvac system either cooling, heating or turning to an off state. 
###         Payload Names
